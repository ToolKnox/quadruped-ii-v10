#ifndef _ROS_quadruped_peripheral_interfacing_ElectricalMeasurements_h
#define _ROS_quadruped_peripheral_interfacing_ElectricalMeasurements_h
...
namespace quadruped_peripheral_interfacing
{
  ...
  class ElectricalMeasurements : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "quadruped_peripheral_interfacing/ElectricalMeasurements"; };
